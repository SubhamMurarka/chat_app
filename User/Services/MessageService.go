...
func (m *msgService) GetNewMessages(ctx context.Context, channelID int64) ([]models.Message, error) {
	msg, err := m.msgrepo.GetNewMessages(ctx, channelID)
	return msg, err
}

func (m *msgService) PaginationMessages(ctx context.Context, channelID int64, lastid uint64) ([]models.Message, error) {
